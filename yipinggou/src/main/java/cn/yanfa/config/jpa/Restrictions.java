        ...
        for (Parameters parameters : value) {
            ...
            switch (parameters.getOperator()) {
                case equals:
                    ...
                    break;
                case like:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.LIKE);
                    break;
                case greaterThanOrEqualTo:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.GTE);
                    break;
                case lessThanOrEqualTo:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.LTE);
                    break;
                case greaterThan:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.GT);
                    break;
                case lessThan:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.LT);
                    break;
                case notequals:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.NE);
                    break;
                case isNull:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.ISNULL);
                    break;
                case isNotNull:
                    ses[i] = new SimpleExpression(parameters.getAttributeName(), parameters.getValue(), Criterion.Operator.ISNOTNULL);
                    break;
            }
            i++;
        }
